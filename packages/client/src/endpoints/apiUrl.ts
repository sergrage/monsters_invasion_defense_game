...
//Forum API
export const baseForumUrl: string = "localhost:3001/api";
export const forumThreadUrl: string = `${baseForumUrl}/forum_thread`;
export const forumMessageUrl: string = `${baseForumUrl}/forum_thread`;
